...
import {
  ...
  DEFAULT_CUSTOM_TYPES, ExtensionBasedMapper, getExtension, joinFilePath, NotImplementedHttpError,
} from '@solid/community-server';
...
export class IpfsExtensionBasedMapper extends BaseFileIdentifierMapper {
  ...
  Promise<ResourceLink> {
    ...
    if (!contentType) {
      ...
      try {
        const files = await this.fs.readdir(folder);
