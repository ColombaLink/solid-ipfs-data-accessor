...
import {
  APPLICATION_OCTET_STREAM, ConflictHttpError, CONTENT_TYPE, DC,
  ExtensionBasedMapper,
  Guarded, guardedStreamFrom, isContainerPath, LDP, NotFoundHttpError, POSIX, RDF, readableToString, Representation,
...
describe('A FileDataAccessor', (): void => {
  ...
  let accessor: BinaryDataAccessor;
  let cache: { data: any };
